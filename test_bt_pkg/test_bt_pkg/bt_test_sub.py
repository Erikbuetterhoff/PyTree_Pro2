...
from action_pkg.action import Empty
...
def tutorial_create_root() -> py_trees.behaviour.Behaviour:
    ...
    drone_not_ok = py_trees_ros.actions.ActionClient(       #direkt aus tutorial kopiert
        name="Return Home",
        action_type=Empty,
        action_name="empty_action",
        action_goal=Empty.Goal(),
        generate_feedback_message=lambda msg: Empty.Feedback()
    )
